        ...
        <div class="modal-dialog" role="document">
            <div class="card card-shadowed p-50 w-400 mb-0" style="max-width: 100%">
                ...
                <form>
                    ...
                    <div class="form-group">
                        <button class="btn btn-bold btn-block btn-primary" @click="attemptLogin()"
                           href="#"     :disabled="!isValidLogin" type="submit">
                            Login
                        </button>
                    </div>
                </form>
                ...
                <p class="text-center text-muted fs-13 mt-20">Don't have an account? <a href="page-register.html">Sign
                    up</a></p>
            </div>
        </div>
    </div>
...
<script>
    ...
    export default {
            ...
            attemptLogin() {
                ...
                axios.post('/login', {
                    ...
                    if (error.response.status==422){
                        this.errors.push("We couldn't verify your account");
                    }
                    else{
        ...
        computed: {
            isValidLogin() {
                return this.isValidateEmail() && this.password && !this.loading;
            }
        }
    }
</script>
